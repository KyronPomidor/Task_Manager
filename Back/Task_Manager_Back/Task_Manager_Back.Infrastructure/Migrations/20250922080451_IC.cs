        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryType = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Categories_TaskCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShopItems_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_TaskCategoryId",
                table: "Categories",
                column: "TaskCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopItems_TaskId",
                table: "ShopItems",
                column: "TaskId");
